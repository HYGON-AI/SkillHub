...
def parse_args(argv=None):
    ...
    importer.add_argument("--license", help="license expression when not already declared in the source")
    ...
    importer.add_argument("--upstream", help="public origin or attribution text when not recorded in the original Skill Card")
