...
- Human-facing repository, banner and catalog product names now consistently use
  `HYGON-AI Agent Skills`; the stable repository slug `HYGON-AI/skillhub` and
  skill ID `skillhub-contributor` are unchanged.
